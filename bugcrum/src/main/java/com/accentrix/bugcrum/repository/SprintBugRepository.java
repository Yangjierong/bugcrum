/*
 * $Id: SprintBugRepository.java 62 2014-12-11 10:32:35Z joe $
 * 
...
@Repository
public interface SprintBugRepository extends JpaRepository<SprintBug, Integer> {

    List<SprintBug> findBySprintId(Integer sprintId);

    @Query("FROM SprintBug sb WHERE sb.sprint.id = ?1 AND sb.bug.assignedTo.id = ?2")
